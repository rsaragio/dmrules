 ...
 */
package https_58_47_47kiegroup_46org_47dmn_47__751C662B_455714_454182_45A239_455DD3F017B1C5;
...
@Path("/Apuracashback")
public class ApuracashbackResource {
    ...
    public Response dmn(java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://kiegroup.org/dmn/_751C662B-5714-4182-A239-5DD3F017B1C5", "Apuracashback");
        org.kie.dmn.api.core.DMNResult decisionResult = decision.evaluateAll(DMNJSONUtils.ctx(decision, variables));
        KogitoDMNResult result = new KogitoDMNResult("https://kiegroup.org/dmn/_751C662B-5714-4182-A239-5DD3F017B1C5", "Apuracashback", decisionResult);
    ...
    public String dmn() throws java.io.IOException {
        return new String(org.drools.util.IoUtils.readBytesFromInputStream(this.getClass().getResourceAsStream(org.kie.dmn.feel.codegen.feel11.CodegenStringUtil.escapeIdentifier("Apuracashback") + ".dmn_nologic")));
    }
